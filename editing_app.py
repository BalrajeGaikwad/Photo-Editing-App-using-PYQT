import os
from PyQt5.QtWidgets import QApplication,QFileDialog,QWidget, QLabel, QPushButton, QListWidget,QComboBox, QHBoxLayout, QVBoxLayout
...
class Editor():
    ...
    def transformImage(self,transformation):
        transformations={
            ...
            "Sharpen": lambda image: image.convert('RGB').filter(ImageFilter.SHARPEN)
        }
